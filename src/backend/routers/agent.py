...
from backend.schemas.requests import AgentTaskRequest, AgentTaskResumeRequest
from backend.schemas.responses import AgentTaskRecordResponse, AgentTaskResponse
...
def stream_agent_task_events(
    ...
    return StreamingResponse(
        _agent_task_event_stream(task_store, task_id, user_id, after_event_id),
